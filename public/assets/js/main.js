...
$(function () {
  ...
  if (typeof Chart !== "undefined") {
    ...
    if ($("#filledLineChart").length) {
      var filledLineChart = document
        .getElementById("filledLineChart")
        .getContext("2d");
    ...
    if ($("#singleLineChart").length) {
      var singleLineChart = document
        .getElementById("singleLineChart")
        .getContext("2d");
    ...
    if ($("#filledWhiteLineChart").length) {
      var filledWhiteLineChart = document
        .getElementById("filledWhiteLineChart")
        .getContext("2d");

      var whiteGradient = filledWhiteLineChart.createLinearGradient(
        0,
        0,
        0,
        200
    ...
    if ($("#doubleLineChart").length) {
      var doubleLineChart = document
        .getElementById("doubleLineChart")
        .getContext("2d");
    ...
    if ($("#barGraphPrimary").length) {
      var barGraphPrimary = document
        .getElementById("barGraphPrimary")
        .getContext("2d");
    ...
    if ($("#barGraphGradient").length) {
      var barGraphGradient = document
        .getElementById("barGraphGradient")
        .getContext("2d");
    ...
    if ($("#barGraphWhite").length) {
      var barGraphWhite = document
        .getElementById("barGraphWhite")
        .getContext("2d");
    ...
    if ($("#barGraphDark").length) {
      var barGraphDark = document
        .getElementById("barGraphDark")
        .getContext("2d");
    ...
    if ($("#barGraphLight").length) {
      var barGraphLight = document
        .getElementById("barGraphLight")
        .getContext("2d");
    ...
    if ($("#doghnutChart").length) {
      var doghnutChart = document
        .getElementById("doghnutChart")
        .getContext("2d");
